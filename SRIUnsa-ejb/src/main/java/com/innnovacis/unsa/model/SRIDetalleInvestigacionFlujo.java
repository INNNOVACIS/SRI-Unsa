...
@Entity
@Table(name = "detalleinvestigacionflujo" )
@NamedQueries({
    ...
    @NamedQuery(name="SRIDetalleInvestigacionFlujo.GetByIdActividad",query="SELECT p FROM SRIDetalleInvestigacionFlujo p WHERE p.NIdActividadInvestigacion = :idEntidad")
})
