...
investigacionApp.service("ActividadesGeneradasService", function (SRIUnsaConfig, $log, $http, $q) {
    ...
    this.enviarInforme = function (request) {
        ...
        $http({
            method: 'POST',
            url : SRIUnsaConfig.SRIUnsaUrlServicio + '/actividadInvestigacionGenerada/enviarInforme',
            data: request
    ...
    this.imprimirInforme = function (request) {
        $log.debug("ActividadesGeneradasService - imprimirInforme");

        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: SRIUnsaConfig.SRIUnsaUrlServicio + '/actividadInvestigacionGenerada/imprimirInforme',
            data: request,
